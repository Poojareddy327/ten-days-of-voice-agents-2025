...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - CUSTOM VERSION")
...
💛 Thanks for visiting Cafe Pooja Reddy!"""
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Cafe Pooja Reddy".
            
            🎯 MISSION: Take coffee orders by systematically collecting:
            Drink, Size, Milk, Extras, Name.
...
if __name__ == "__main__":
    ...
    print("👤 Customized by: Pooja Reddy")
    print("⚡" * 25 + "\n")
