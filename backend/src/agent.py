...
class FoodAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Robin', a helpful assistant for 'Poojitha Reddy Shop', an Indian grocery store.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🇮🇳" * 12)
    logger.info("🚀 STARTING POOJITHA REDDY SHOP (Indian Context + Auto-Tracking)")
